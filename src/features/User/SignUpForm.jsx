    ...
    return (
        <>
            ...
            <main className="container main-content">
                ...
                {(status==="error") && (<div className="alert alert-danger">This 'username' exists already, please pick a different one.</div>)}
                ...
                <form onSubmit={formHandler}>
                    ...
                    <div className="col-md-4 mb-2">
                        ...
                        <div className="input-group">
                            ...
                            <input type="text" className={`form-control border-info ${status==="error" && "is-invalid"}`} id="username" aria-describedby="inputGroupPrepend" onChange={(e) => setUsername(e.target.value)} value={username} required />
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-2">
                        ...
                        <input type="text" className={`form-control border-info ${phoneNumber.length !== 10 && phoneNumber.length > 0 ? "is-invalid" : ""}`} id="phoneNumber" minLength={10} maxLength={10} onChange={(e) => {const value = e.target.value.replace(/[^0-9]/g, ""); setPhoneNumber(value)}} value={phoneNumber} required />
                    </div>
